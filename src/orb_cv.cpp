...
int main(int argc, char *argv[])
{
    ...
    Mat outimg1;
    drawKeypoints(img_1, kp_1, outimg1, Scalar::all(-1), DrawMatchesFlags::DEFAULT);
    ...
    Mat img_match;
    Mat img_goodmatch;
    drawMatches(img_1, kp_1, img_2, kp_2, matches, img_match);
    drawMatches(img_1, kp_1, img_2, kp_2, good_matches, img_goodmatch);
