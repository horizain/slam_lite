...
int Frontend::FeatureMatch(Frame &frame_reference, Frame &frame_current,
                           std::vector<int> matchFeatureIndexs,
                           int windowsSize) {
  int numMatches = 0;
}
...
inline bool Frontend::Triangulation(SE3 &pose_reference, SE3 &pose_current,
